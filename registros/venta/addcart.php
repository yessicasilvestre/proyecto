...
if(!empty($_POST)){
	if(isset($_POST['id']) && isset($_POST['q'])){
		...
		$_SESSION['carr']=array( array('id_producto'=>$_POST['id'],'costo_venta'=>$_POST['q']));
		}else{
			...
			if($repeated){
				...
				array_push($cart, array('id_producto'=>$_POST['id'],'costo_venta'=> $_POST['q']));
				$_SESSION['carr'] = $cart;
				
			}
		}
		print "<script>window.location='formuventa.php';</script>";
	}
	}
